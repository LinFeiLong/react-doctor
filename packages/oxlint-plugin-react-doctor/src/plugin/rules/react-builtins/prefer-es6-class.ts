...
const ALWAYS_MESSAGE = "Use a normal `class` for this component instead of `createReactClass`.";
const NEVER_MESSAGE = "Use `createReactClass` for this component instead of a `class`.";

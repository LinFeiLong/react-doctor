...
const MESSAGE =
  "useSelector returning a new object or array re-renders on every dispatched action, because the default `===` check always sees a fresh value. Return a primitive, split into several useSelector calls, or pass `shallowEqual` as the second argument.";

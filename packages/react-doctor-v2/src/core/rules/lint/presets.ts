...
export const REACT_NATIVE_OXLINT_RULES: OxlintRuleSeverityMap = {
  "react-doctor/expo-no-axios": "warn",
  ...
  "react-doctor/rn-no-web-dom-elements": "warn",
  ...
  "react-doctor/rn-scrollview-content-container-padding": "warn",
...
export const TANSTACK_AI_OXLINT_RULES: OxlintRuleSeverityMap = {
  "react-doctor/tanstack-ai-chat-lifecycle-middleware": "warn",
  "react-doctor/tanstack-ai-no-direct-client-import": "warn",
  "react-doctor/tanstack-ai-no-manual-sse-response": "warn",
  "react-doctor/tanstack-ai-no-vercel-sdk-patterns": "warn",
  "react-doctor/tanstack-ai-output-schema": "warn",
};
...
export const TANSTACK_QUERY_OXLINT_RULES: OxlintRuleSeverityMap = {
  ...
  "react-doctor/query-no-unstable-deps": "warn",
  "react-doctor/query-no-unstable-query-key": "error",
};

export const ECOSYSTEM_OXLINT_RULES: OxlintRuleSeverityMap = {
  "react-doctor/tailwind-no-conflicting-classes": "warn",
  "react-doctor/tailwind-oklch-alpha-syntax": "error",
  "react-doctor/motion-no-hover-transform-on-target": "warn",
  "react-doctor/motion-no-motion-in-lazymotion-strict": "warn",
  "react-doctor/swr-no-empty-key": "warn",
  "react-doctor/swr-no-unstable-key": "error",
  "react-doctor/mobx-observer-named-component": "warn",
  "react-doctor/i18n-no-literal-jsx-text": "warn",
  "react-doctor/i18n-no-dynamic-translation-key": "warn",
  "react-doctor/shadcn-no-direct-radix-import": "warn",
  "react-doctor/radix-aschild-single-child": "error",
  "react-doctor/rhf-no-watch-render": "warn",
  "react-doctor/rhf-no-nested-object-setvalue": "warn",
  "react-doctor/testing-await-user-event": "error",
  "react-doctor/testing-no-container-query": "warn",
  "react-doctor/storybook-await-play-interactions": "error",
  "react-doctor/r3f-no-new-in-frame": "error",
  "react-doctor/r3f-no-clone-in-frame": "error",
  "react-doctor/r3f-no-set-state-in-frame": "warn",
};
...
export const GLOBAL_REACT_DOCTOR_OXLINT_RULES: OxlintRuleSeverityMap = {
  "react-doctor/no-derived-state-effect": "warn",
  "react-doctor/no-fetch-in-effect": "warn",
  "react-doctor/no-mirror-prop-effect": "warn",
  "react-doctor/no-aria-expanded-without-controls": "warn",
  "react-doctor/no-aria-invalid-without-describedby": "warn",
  ...
  "react-doctor/no-settimeout-state-fix": "warn",
  ...
  "react-doctor/advanced-init-once": "warn",
  "react-doctor/advanced-use-latest": "warn",
  "react-doctor/async-api-routes": "warn",
  "react-doctor/async-cheap-condition-before-await": "warn",
  "react-doctor/async-dependencies": "warn",
  "react-doctor/async-suspense-boundaries": "warn",
  "react-doctor/bundle-conditional": "warn",
  "react-doctor/bundle-preload": "warn",
  "react-doctor/client-event-listeners": "warn",
  "react-doctor/client-swr-dedup": "warn",
  "react-doctor/js-cache-function-results": "warn",
  "react-doctor/js-request-idle-callback": "warn",
  "react-doctor/rendering-activity": "warn",
  "react-doctor/rendering-content-visibility": "warn",
  "react-doctor/rendering-hydration-suppress-warning": "warn",
  "react-doctor/rendering-resource-hints": "warn",
  "react-doctor/rerender-memo": "warn",
  "react-doctor/rerender-split-combined-hooks": "warn",
  "react-doctor/rerender-use-deferred-value": "warn",
  "react-doctor/rerender-use-ref-transient-values": "warn",
  "react-doctor/server-cache-lru": "warn",
  "react-doctor/server-cache-react": "warn",
  "react-doctor/server-parallel-fetching": "warn",
  "react-doctor/server-parallel-nested-fetching": "warn",
  "react-doctor/server-serialization": "warn",
  ...
  "react-doctor/no-blocked-paste": "warn",
  "react-doctor/no-button-navigation": "warn",
  "react-doctor/no-icon-only-button-without-label": "warn",
  ...
  "react-doctor/no-swallowed-error": "warn",
  ...
  "react-doctor/effect-no-chain-state-updates": "warn",
  "react-doctor/effect-no-event-handler": "warn",
  "react-doctor/effect-no-adjust-state-on-prop-change": "warn",
  "react-doctor/effect-no-reset-all-state-on-prop-change": "warn",
  "react-doctor/effect-no-pass-live-state-to-parent": "warn",
  "react-doctor/effect-no-pass-data-to-parent": "warn",

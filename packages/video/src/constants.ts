import type { RuleScrollGroup, ScannedIssue } from "./types";
...
export const SCANNED_ISSUES: ScannedIssue[] = [
  ...
  {
    message: "Unnecessary useEffect for transform",
    severity: "warning",
    pointsLost: 2,
    file: "Price.tsx:13",
  },
  ...
  {
    message: "Duplicate provider in tree",
    severity: "warning",
    pointsLost: 2,
    file: "layout.tsx:31",
  },
  {
    message: "String ref instead of createRef",
    severity: "error",
    pointsLost: 5,
    file: "Legacy.tsx:58",
  },
  ...
  {
    message: "Object spread in dependency array",
    severity: "error",
    pointsLost: 5,
    file: "useFilters.ts:24",
  },
  {
    message: "Unmemoized context value",
    severity: "warning",
    pointsLost: 2,
    file: "CartProvider.tsx:9",
  },
  ...
  {
    message: "Render prop causes re-mount",
    severity: "error",
    pointsLost: 5,
    file: "DataGrid.tsx:73",
  },
  {
    message: "Missing displayName on memo",
    severity: "warning",
    pointsLost: 2,
    file: "Badge.tsx:4",
  },
  {
    message: "Controlled input without onChange",
    severity: "error",
    pointsLost: 5,
    file: "Checkout.tsx:56",
  },
  {
    message: "Proper use of startTransition",
    severity: "ok",
    pointsLost: 0,
    file: "Search.tsx:48",
  },
  {
    message: "Effect depends on unstable reference",
    severity: "error",
    pointsLost: 5,
    file: "useSync.ts:31",
  },
  ...
  {
    message: "Mutation inside render function",
    severity: "error",
    pointsLost: 5,
    file: "Summary.tsx:27",
  },
  {
    message: "Promise not handled in effect",
    severity: "warning",
    pointsLost: 2,
    file: "useFetch.ts:15",
  },
  ...
  {
    message: "Excessive re-renders from context",
    severity: "warning",
    pointsLost: 2,
    file: "ThemeToggle.tsx:22",
  },
  {
    message: "Missing aria attributes on button",
    severity: "warning",
    pointsLost: 2,
    file: "IconBtn.tsx:8",
  },
  {
    message: "useLayoutEffect in SSR component",
    severity: "error",
    pointsLost: 5,
    file: "Header.tsx:34",
  },
  ...
  {
    message: "Non-serializable value in state",
    severity: "warning",
    pointsLost: 2,
    file: "useMap.ts:7",
  },
  ...
  {
    message: "dangerouslySetInnerHTML used safely",
    severity: "ok",
    pointsLost: 0,
    file: "Markdown.tsx:14",
  },
  {
    message: "Effect cleanup prevents memory leak",
    severity: "ok",
    pointsLost: 0,
    file: "Socket.tsx:28",
  },
  {
    message: "Throwing in render without boundary",
    severity: "error",
    pointsLost: 5,
    file: "Detail.tsx:45",
  },
  {
    message: "Synthetic event accessed async",
    severity: "error",
    pointsLost: 5,
    file: "Dropdown.tsx:37",
  },
  { message: "Fragment avoids extra DOM node", severity: "ok", pointsLost: 0, file: "List.tsx:9" },
  {
    message: "Debounced input handler",
    severity: "ok",
    pointsLost: 0,
    file: "Autocomplete.tsx:53",
  },
  {
    message: "State update on unmounted component",
    severity: "error",
    pointsLost: 5,
    file: "Notification.tsx:41",
  },
  ...
  {
    message: "Computed value not memoized",
    severity: "warning",
    pointsLost: 2,
    file: "Stats.tsx:30",
  },
  {
    message: "Proper form submission handling",
    severity: "ok",
    pointsLost: 0,
    file: "Register.tsx:22",
  },
  {
    message: "Correct use of useImperativeHandle",
    severity: "ok",
    pointsLost: 0,
    file: "Player.tsx:46",
  },
  {
    message: "Timer not cleared on unmount",
    severity: "error",
    pointsLost: 5,
    file: "Toast.tsx:16",
  },
  {
    message: "Optimistic update pattern correct",
    severity: "ok",
    pointsLost: 0,
    file: "Like.tsx:8",
  },
  {
    message: "Prop type mismatch at boundary",
    severity: "warning",
    pointsLost: 2,
    file: "Wrapper.tsx:35",
  },
  {
    message: "Effect fires twice in StrictMode",
    severity: "warning",
    pointsLost: 2,
    file: "Analytics.tsx:20",
  },
  {
    message: "Proper use of useDeferredValue",
    severity: "ok",
    pointsLost: 0,
    file: "Results.tsx:39",
  },
...
export const RULE_SCROLL_GROUPS: RuleScrollGroup[] = [
  {
    title: "Preact-bucket rules (5)",
    subtitle: "rules/preact/, gated on preact or pure-preact capability",
    rows: [
      {
        ruleId: "preact-no-render-arguments",
        source: "Differences - Arguments in render()",
        flags:
          "Class-component render(props, state) signature on classes extending Component/PureComponent/React.Component/Preact.Component. Skips static render and TypeScript this: parameters.",
        badgeLabel: "Gate",
        badgeText: "preact",
      },
      {
        ruleId: "preact-no-children-length",
        source: "preact/compat source",
        flags:
          "Direct array-method access (.length, .map, .forEach, ...) on props.children - Preact does not wrap a single child in an array.",
        badgeLabel: "Gate",
        badgeText: "preact",
      },
      {
        ruleId: "preact-prefer-oninput",
        source: "Differences - onInput vs onChange",
        flags:
          "onChange on text-typed <input> / <textarea>. Per-file compat detection silences when the file imports from preact/compat, react, etc.",
        badgeLabel: "Gate",
        badgeText: "preact",
      },
      {
        ruleId: "preact-prefer-ondblclick",
        source: "Differences - Main differences",
        flags:
          "onDoubleClick on lowercase host elements - Preact's DOM event is dblclick, the React-style handler never fires.",
        badgeLabel: "Gate",
        badgeText: "pure-preact",
      },
      {
        ruleId: "preact-no-react-hooks-import",
        source: "preact-hooks-debugging skill",
        flags:
          'import { useState, useEffect, ... } from "react" in pure-Preact apps. The #1 cause of the __H undefined runtime crash. Covers all 15 React hooks.',
        badgeLabel: "Gate",
        badgeText: "pure-preact",
      },
    ],
  ...
  {
    title: "Universal rules sourced from preact/debug (5)",
    subtitle: "Apply to React, Preact, and any other JSX library",
    rows: [
      {
        ruleId: "html-no-nested-interactive",
        source: "getDomChildren(vnode).indexOf(type) !== -1 for <a>/<button>",
        flags: "<a> inside <a>, <button> inside <button>",
        badgeLabel: "Bucket",
        badgeText: "correctness",
      },
      {
        ruleId: "html-no-invalid-paragraph-child",
        source: "ILLEGAL_PARAGRAPH_CHILD_ELEMENTS regex, verbatim",
        flags:
          "Block-level children inside <p> (30 elements: address, article, aside, blockquote, details, div, dl, fieldset, figcaption, figure, footer, form, h1-h6, header, hgroup, hr, main, menu, nav, ol, p, pre, search, section, table, ul).",
        badgeLabel: "Bucket",
        badgeText: "correctness",
      },
      {
        ruleId: "html-no-invalid-table-nesting",
        source: "Table-element nesting checks in options.diffed",
        flags:
          "<table> in <table> except via <td> or <th>; <thead>/<tbody>/<tfoot> not direct child of <table>; <tr> not in row group; <td>/<th> not in <tr>. Walks past user components and bails when DOM shape becomes opaque.",
        badgeLabel: "Bucket",
        badgeText: "correctness",
      },
      {
        ruleId: "hooks-no-nan-in-deps",
        source: "isNaN(arg) hook-arg validation",
        flags:
          "Literal NaN and Number.NaN in dep arrays of useEffect, useLayoutEffect, useInsertionEffect, useCallback, useMemo, useImperativeHandle (deps at index 2). useSignalEffect excluded - single-arg API.",
        badgeLabel: "Bucket",
        badgeText: "state-and-effects",
      },
      {
        ruleId: "prefer-html-dialog",
        source: "Designed against the same DOM-correctness lens preact/debug uses",
        flags:
          'role="dialog" / role="alertdialog" and aria-modal="true" on non-<dialog> host elements. Also nudges toward <button commandfor="..." command="show-modal"> declarative triggers in Chrome 135+.',
        badgeLabel: "Bucket",
        badgeText: "a11y",
      },
    ],
...
export const SCENE_TYPING_DURATION_FRAMES = 45;
export const SCENE_FILE_SCAN_DURATION_FRAMES = 150;
export const SCENE_DIAGNOSE_AND_FIX_DURATION_FRAMES = 310;
export const SCENE_SCORE_REVEAL_DURATION_FRAMES = 110;
export const TRANSITION_DURATION_FRAMES = 15;

export const TOTAL_DURATION = SCENE_TYPING_DURATION_FRAMES + SCENE_FILE_SCAN_DURATION_FRAMES;

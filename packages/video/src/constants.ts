...
export const COMMAND_PREFIX = "npx ";
export const COMMAND_TYPED_TEXT = "react-doctor@latest";
export const COMMAND = `${COMMAND_PREFIX}${COMMAND_TYPED_TEXT}`;
...
export const TYPING_INITIAL_DELAY_FRAMES = 5;
...
export const FRAMES_PER_FILE = 1;
...
export const SCENE_TYPING_DURATION_FRAMES =
  TYPING_INITIAL_DELAY_FRAMES + COMMAND_TYPED_TEXT.length * CHAR_FRAMES + TYPING_POST_PAUSE_FRAMES;
export const SCENE_DIAGNOSE_AND_FIX_DURATION_FRAMES = 200;
export const SCENE_SCORE_REVEAL_DURATION_FRAMES = 110;
export const TRANSITION_DURATION_FRAMES = 0;
export const SCROLL_TO_DIAGNOSE_TRANSITION_DURATION_FRAMES = 0;
export const SCENE_FILE_SCAN_DURATION_FRAMES =
  TRANSITION_DURATION_FRAMES +
  24 +
  SCANNED_FILES.length * FRAMES_PER_FILE +
  SCROLL_TO_DIAGNOSE_TRANSITION_DURATION_FRAMES;
